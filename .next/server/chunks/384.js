...
// EXTERNAL MODULE: ./node_modules/framer-motion/node_modules/tslib/tslib.es6.mjs
var tslib_es6 = __webpack_require__(2888);
...
// EXTERNAL MODULE: ./node_modules/framer-motion/node_modules/tslib/tslib.es6.mjs
var tslib_es6 = __webpack_require__(2888);
;// CONCATENATED MODULE: ./node_modules/popmotion/node_modules/tslib/tslib.es6.mjs
/******************************************************************************
...
var easingDefinitionToFunction = function (definition) {
    if (Array.isArray(definition)) {
        ...
        (0,external_hey_listen_.invariant)(easingLookup[definition] !== undefined, "Invalid easing type '".concat(definition, "'"));
...
function getAnimation(key, value, target, transition, onComplete) {
    ...
    (0,external_hey_listen_.warning)(isOriginAnimatable === isTargetAnimatable, "You are trying to animate ".concat(key, " from \"").concat(origin, "\" to \"").concat(target, "\". ").concat(origin, " is not an animatable value - to enable this animation set ").concat(origin, " to a value animatable to ").concat(target, " via the `style` property."));
    function start() {
        var options = {
            from: origin,
            to: target,
...
var transitions = __webpack_require__(4367);
            ...
            if (this.options.animate !== false &&
                ...
                this.addEventListener("didUpdate", function (_a) {
                    ...
                    if (((_d = _this.resumeFrom) === null || _d === void 0 ? void 0 : _d.instance) ||
                        ...
                        _this.startAnimation((0,tslib_es6/* __assign */.pi)((0,tslib_es6/* __assign */.pi)({}, (0,transitions/* getValueTransition */.ev)(layoutTransition, "layout")), { onComplete: onLayoutAnimationComplete }));
                    }
                    else {
...
function motion_createMotionComponent(_a) {
    ...
    function MotionComponent(props, externalRef) {
         ...
         */
        return (external_react_.createElement(VisualElementHandler, { visualElement: context.visualElement, props: (0,tslib_es6/* __assign */.pi)((0,tslib_es6/* __assign */.pi)({}, config), props) },
            features,
...
function createLifecycles() {
    ...
    managers.forEach(function (manager, i) {
        ...
        lifecycles["notify" + names[i]] = function () {
            ...
            manager.notify.apply(manager, (0,tslib_es6/* __spreadArray */.ev)([], (0,tslib_es6/* __read */.CR)(args), false));
        };
    });
    return lifecycles;
}
...
function getVariableValue(current, element, depth) {
    ...
    (0,external_hey_listen_.invariant)(depth <= maxDepth, "Max CSS variable fallback depth detected in property \"".concat(current, "\". This may indicate a circular fallback dependency."));
...
function MeasureLayout(props) {
    ...
    return (external_react_.createElement(MeasureLayoutWithContext, (0,tslib_es6/* __assign */.pi)({}, props, { layoutGroup: layoutGroup, switchLayoutGroup: (0,external_react_.useContext)(SwitchLayoutGroupContext), isPresent: isPresent, safeToRemove: safeToRemove })));
}
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2888);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2888);
/* harmony import */ var _animation_utils_transitions_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4367);
/* harmony import */ var _setters_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5759);
...
function animateTarget(visualElement, definition, _a) {
    ...
    for (var key in target) {
        ...
        var animation = (0,_animation_utils_transitions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .startAnimation */ .b8)(key, value, valueTarget, (0,tslib__WEBPACK_IMPORTED_MODULE_1__/* .__assign */ .pi)({ delay: delay }, transition));
...
/* harmony export */ });
/* unused harmony exports __decorate, __param, __esDecorate, __runInitializers, __propKey, __setFunctionName, __metadata, __awaiter, __generator, __createBinding, __exportStar, __values, __spread, __spreadArrays, __await, __asyncGenerator, __asyncDelegator, __asyncValues, __makeTemplateObject, __importStar, __importDefault, __classPrivateFieldGet, __classPrivateFieldSet, __classPrivateFieldIn, __addDisposableResource, __disposeResources */
/******************************************************************************
Copyright (c) Microsoft Corporation.
