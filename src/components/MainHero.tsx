      ...
      <div className="sm:text-center lg:text-left">
        ...
        <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
          <div className="rounded-md shadow">
            <a
            onClick={()=>{
              // promot user to get his number
              const clientnumber=prompt("Please enter your number");
             
              alert("thanks one of our team will call you soon from this number "+clientnumber+"");
